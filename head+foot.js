...
$(function(){
    $('header')
    	.append('<h3><i class="material-icons">date_range</i> 26-27-28 juin</h3>')
    	.append('<h3><i class="material-icons">location_on</i> Grenoble</h3>')
    	.append('<img src="logo.png" alt="Logo CPPiades">');
    $('footer')
